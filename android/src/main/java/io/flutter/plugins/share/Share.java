...
class Share {
  ...
  void share(String packageName,String text, String subject) {
    ...
    Intent chooserIntent = Intent.createChooser(share, "Share" /* dialog title optional */);
    if (activity != null) {
      activity.startActivity(chooserIntent);
    } else {
      chooserIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
      activity.startActivity(chooserIntent);
    }//Facebook App package
